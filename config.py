...
ADMIN = int(os.environ.get("ADMIN", "7364818327"))
...
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002319456366"))


# Mongo DB Database Config
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://thanos554433:0Zc0EC9hg7YWDlwp@cluster0.4cead.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
